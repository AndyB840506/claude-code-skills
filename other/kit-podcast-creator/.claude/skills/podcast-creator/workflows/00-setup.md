...
## Paso 4.5 — Segmentos opcionales y tono regional

Pregunta en un solo mensaje:

> **Dos preguntas más antes de terminar:**
>
> **A. ¿Van a tener episodios especiales con invitados?**
> (artistas, expertos, promotores, dueños de negocios, cualquier personaje interesante del mundo de tu podcast)
>
> Si SÍ:
> - ¿Cómo quieres llamar ese formato especial? (puede ser "La Entrevista", "En el Cuarto", "El Invitado", o el nombre que quieras)
> - ¿Se graba presencial o remoto?
> - ¿Qué tipo de invitados esperan traer? (artistas, expertos, emprendedores, académicos, etc.)
>
> **B. ¿Van a mencionar eventos, lanzamientos o noticias en los episodios?**
> (conciertos próximos, libros nuevos, productos, lo que sea relevante a tu audiencia)
>
> Si SÍ → crearé una base de datos de eventos (`eventos.json`) que pueden actualizar antes de cada grabación.

Escucha las respuestas y guarda en el JSON:

```json
"segmento_invitado": {
  "activo": true,
  "nombre": "[nombre que eligieron]",
  "formato": "presencial | remoto",
  "tipos_invitados": ["artista", "promotor", "..."]
},
"segmento_promo": {
  "activo": true,
  "conductor": "[nombre del host que lo conduce]",
...
### Tono regional y lenguaje

Pregunta:

> **¿De dónde son ustedes? ¿Hay modismos, jerga o forma de hablar propia de la región o el podcast?**
>
> Esto me ayuda a escribir los guiones en el idioma de ustedes — no en español neutro.
>
> Ejemplo: "Somos bogotanos, usamos palabras como ala, sumerce, qué chirriada..."
...
"lenguaje": {
  "region": "[país/ciudad]",
  "estilo": "[cachaco/rolo/paisa/regio/porteño/chileno/neutro/...]",
  "palabras_frecuentes": ["...", "..."],
  "palabras_prohibidas": ["...", "..."],
