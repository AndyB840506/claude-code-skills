...
| EP.006 (T2·E1) | El Club de los 27 | **publicado** — confirmado por Andrés el 2026-08-03. ⚠️ **Falta la URL de Spotify y la fecha exacta de salida en esta fila** (la memoria decía viernes 2026-07-31, sin verificar contra Spotify). Regrabado el 2026-07-28. Checkpoint de plays: ~2026-08-14. Guion: `scripts/EP006-club-de-los-27.html`, ~5.208 palabras narracion (~40.5 min estimados, calibracion MPD 159 wpm/+23.5%), formato solo. ESTRENO DE LA TEMPORADA 2. Publico = T2·E1; interno = 6º producido. Faltan: SRT, metadata/show-notes, quote cards, plan de lanzamiento. |
