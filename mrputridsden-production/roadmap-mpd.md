...
| EP.03 (T2·E3) | La Bestia que el rock volvió inmortal | **publicado** - https://open.spotify.com/episode/4CC5CsJPY75Wyg5Yd5RR6O, salió 2026-08-17 (lunes, como programado), ~33 min. Verificado en vivo 2026-08-20 (WebFetch + curl). Sitio actualizado a "Ya disponible" y redeployado. Grabado 2026-08-15 (32:45 real, corto vs target ~43 min, mismo patrón que EP.005 — se publicó as-is). Show notes/YouTube/social/artwork final/quote cards/clip de audio listos (`episodios/temporada-2/`). Experimento de estilo Tales from the Crypt, solo este episodio — pendiente decisión de Andrés sobre si se adopta para T2 en general. |
| EP.04 (T2·E4) | Paul is Dead | **guion listo** - guion aprobado 2026-08-20 (~35 min, 4.452 palabras host-text, corto vs target ~43 min — aprobado as-is por Andrés, mismo patrón que EP.005/EP.03). Guion: `scripts/EP04-paul-is-dead.html`. Ángulo: Fred LaBour/Michigan Daily 1969, cerrando con comparativa de "dobles" modernos (Avril Lavigne, reptilianos, Bieber). Cierre NO anuncia próximo expediente. Artwork final listo (`episodios/temporada-2/artwork-ep04.md`) — concepto: periódico enmarcado en el óvalo de La Guarida. Pendiente: grabación. |
