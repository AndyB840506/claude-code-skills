...
metadata de YouTube, portadas compuestas (1:1/9:16/16:9), quote cards, corre su propio
gate de aprobación, y hace commit + push del archivo consolidado.

> **No pidas metadata de SafeCreative** — retirada el 2026-07-26 para BTQ.
> **YouTube sí se genera:** el episodio llega solo por ingesta de RSS con la metadata de
> Spotify, y Andy la sobrescribe a mano en Studio. Ver
> `episode-launch/workflows/step2-generate-assets.md` §C.
