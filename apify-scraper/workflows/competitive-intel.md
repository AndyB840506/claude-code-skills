...
2. **Extract structured data** — extract tiers, prices, key features, positioning statement per competitor

### Output fields
Step 1: `text` (clean markdown with pricing tables), `url`, `metadata.title`
Step 2: structured JSON with tiers, prices, feature flags per competitor
