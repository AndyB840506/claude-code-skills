# Portada de MPD EP.03 (T2*E3) "La Bestia que el rock volvio inmortal" - copiado de
# mpd-portada-ep02-t2.py y adaptado (misma decision de Andres: sin draw_numeral, la
# escena ya integra el concepto sin necesitar un numero central).
#
# Escena: estudio "La Guarida" con marco ovalado (retrato disuelto/ilegible) sobre la
# chimenea, dos vinilos reales a los lados. Generada con Z-Image Turbo (seed 3082026),
# upscaleada a 3000x3000 con RealESRGAN, pasada por night_grade variante E.
#
# Uso: python mpd-portada-ep03-t2.py
...
TITLE = "La Bestia que el rock volvió inmortal"
TAGLINE = "Sgt. Pepper's, Bowie y Ozzy: el mismo hombre."
...
def build_1x1(scene):
    ...
    return save(im, "MPD-T2E03-PORTADA-3000.jpg")


def build_16x9(scene):
    im = crop_aspect(scene, 16 / 9, y_center=0.30).resize((1920, 1080), Image.LANCZOS)
    ...
    return save(im, "MPD-T2E03-16x9-FINAL.png")
...
def build_9x16(scene):
    ...
    return save(im, "MPD-T2E03-9x16-FINAL.png")
