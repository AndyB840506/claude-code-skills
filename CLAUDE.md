...
- **Al escribir un prompt, un guion o una config desde un documento de reglas, abrir primero el último ENTREGABLE publicado** de esa familia. El entregable es el estado real; el documento es la intención.
