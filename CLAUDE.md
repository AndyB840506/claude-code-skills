...
**Al diagnosticar variables de entorno, nunca imprimir los NOMBRES sin filtrar.** Un `SetEnvironmentVariable` con los argumentos al revés guarda la key como *nombre* de la variable; listar los nombres para buscarla la vuelca al transcript. Mordió el 2026-09-23: dos keys de Anthropic expuestas y revocadas. Filtrar antes de imprimir (`sk-*`, `xai-*`, nombres de más de 40 caracteres → contar, no mostrar) y reportar solo presencia y largo del valor.
