...
| EP.026 | **Oficio de Jefe #3** — `Por qué no llena esa vacante hace cuatro meses: el candidato unicornio` | **guion completo, sin grabar (2026-08-13)** — casos verificados en fuente primaria, lints en PASS. Ver `pipeline-state-ep026.md` para el detalle completo, incluidos 2 pendientes antes de grabar (re-verificación de fuentes, visto bueno de Andy sobre nombrar a Irina Lara en el caso Aerocivil/Procuraduría). **Renumerado de EP.025 a EP.026 el 2026-08-07** para que el episodio ya producido (camiseta) ocupe el próximo cupo real. Ver nota abajo |
