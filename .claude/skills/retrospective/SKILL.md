...
**Memory conflicts:**
- ¿Algún archivo de memoria contradice el CLAUDE.md del proyecto activo?
- Si sí → flagear para actualizar o eliminar la memoria stale antes de que cause errores en sesiones futuras
...
- **CLAUDE.md vs memoria:** Si una regla fue violada múltiples veces y solo existía en memoria → pertenece al CLAUDE.md global, no a memoria. Memoria = contexto de proyecto. CLAUDE.md = reglas de comportamiento que deben aplicarse siempre.
