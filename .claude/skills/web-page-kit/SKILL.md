...
- `docs/design-guide.md` — Animation patterns, scroll-video, self-contained HTML rules; Rule 8 is the page-level aesthetic authority here (ui-ux-pro-max is for standalone components, not a full site's tone)
