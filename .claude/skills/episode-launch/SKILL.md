...
description: >
  ...
  in one pass: Spotify SEO (description + preview), social plan 4-day calendar,
  portadas compuestas deterministas (1:1 · 9:16 · 16:9), quote cards, and git commit + push.
  YouTube y SafeCreative están RETIRADOS desde 2026-07-26 (YouTube entra por RSS).
...
2. [workflows/step2-generate-assets.md](workflows/step2-generate-assets.md) — generate Spotify SEO + social plan (parallel, in one response); portadas y quote cards se **componen**, no se promptean. **No se genera metadata de YouTube** (§C retirada 2026-07-26)
